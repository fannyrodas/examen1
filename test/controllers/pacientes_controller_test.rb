...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { edad: @paciente.edad, enfermedad: @paciente.enfermedad, nombre: @paciente.nombre, tratamiento: @paciente.tratamiento }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { edad: @paciente.edad, enfermedad: @paciente.enfermedad, nombre: @paciente.nombre, tratamiento: @paciente.tratamiento }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
