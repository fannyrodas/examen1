...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { edad: @empleado.edad, nombre: @empleado.nombre, puesto: @empleado.puesto, salario: @empleado.salario }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { edad: @empleado.edad, nombre: @empleado.nombre, puesto: @empleado.puesto, salario: @empleado.salario }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
